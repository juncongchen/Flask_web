    ...
    try:
        ...
        for k in key:
            ...
            for item in data[k]:
                ...
                t=k+ ((str(item[2])) if len(str(item[2]))==2 else '0'+str(item[2]))
...
@app.route('/getmetric', methods=['GET', 'POST'])
def getmetric() :
    sql = """SELECT metric_name FROM t_metric """
